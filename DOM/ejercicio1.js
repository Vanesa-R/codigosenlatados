// Ejercicio 1: CREANDO NODOS

let elemento = document.createElement("p"), //Crear elemento
...
document.getElementById("parrafo").appendChild(elemento); // Agregamos el nuevo elemento